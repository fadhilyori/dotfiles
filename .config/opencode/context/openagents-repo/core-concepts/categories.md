...
/home/fadhilyori/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/fadhilyori/.config/opencode/context/{category}
...
```bash
cat > /home/fadhilyori/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/fadhilyori/.config/opencode/context/{category}/
...
Loads: `/home/fadhilyori/.config/opencode/context/ui/web/react-patterns.md`
