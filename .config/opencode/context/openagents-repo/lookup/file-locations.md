...
| **Context files** | `/home/fadhilyori/.config/opencode/context/` |
...
| **New context** | `/home/fadhilyori/.config/opencode/context/{category}/{name}.md` |
...
```
/home/fadhilyori/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/fadhilyori/.config/opencode/context/core/standards/code-quality.md`
- `/home/fadhilyori/.config/opencode/context/ui/web/react-patterns.md`
- `/home/fadhilyori/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/fadhilyori/.config/opencode/context/{category}/

# All context
find /home/fadhilyori/.config/opencode/context -name "*.md"
```
