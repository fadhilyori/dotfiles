...
- Answer is in `/home/fadhilyori/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/fadhilyori/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/fadhilyori/.config/opencode/context/core/workflows/task-delegation-basics.md`
