...
```bash
npx ts-node /home/fadhilyori/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/fadhilyori/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
